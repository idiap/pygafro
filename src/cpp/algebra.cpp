...
template <class T> const std::string __repr__(T &obj) {
  std::ostringstream s;
  s << obj;
  return s.str();
}
...
#define DECLARE_EXPRESSION(DERIVED, RESULT)                                    \
  py::class_<gafro::Expression<DERIVED, RESULT>>(m, "Expression_" #DERIVED     \
                                                    "_" #RESULT)               \
      .def(py::init<>())                                                       \
      .def("evaluate", &gafro::Expression<DERIVED, RESULT>::evaluate)          \
      .def("__repr__", &__repr__<gafro::Expression<DERIVED, RESULT>>,          \
           py::is_operator());

#define DECLARE_UNARY_EXPRESSION(DERIVED, OPERAND, RESULT)                     \
  typedef gafro::UnaryExpression<DERIVED, OPERAND, RESULT>                     \
      UnaryExpression_##DERIVED;                                               \
                                                                               \
  typedef gafro::Expression<UnaryExpression_##DERIVED, RESULT>                 \
      Expression_UnaryExpression_##DERIVED;                                    \
                                                                               \
  DECLARE_EXPRESSION(UnaryExpression_##DERIVED, RESULT);                       \
                                                                               \
  py::class_<UnaryExpression_##DERIVED, Expression_UnaryExpression_##DERIVED>( \
      m, "UnaryExpression_" #DERIVED)                                          \
      .def(py::init<const OPERAND &>());

#define DECLARE_UNARY_EXPRESSION_WITH_NAMES(DERIVED, OPERAND, RESULT,          \
...
#include "multivectors.h"
  ...
  // PointPair class
  py::class_<PointPair, Multivector_e01e02e12e03e13e23e0ie1ie2ie3i>(m,
                                                                    "PointPair")
      .def(py::init<>())
  ...
  // Circle class
  py::class_<Circle, Multivector_e012e013e023e123e01ie02ie12ie03ie13ie23i>(
      m, "Circle")
      .def(py::init<
           const Multivector_e012e013e023e123e01ie02ie12ie03ie13ie23i &>())
      .def(py::init<const Point &, const Point &, const Point &>())
      .def("getCenter", &Circle::getCenter)
      .def("getPlane", &Circle::getPlane)
      .def("getRadius", &Circle::getRadius)
      .def("getMotor", &Circle::getMotor)
      .def("getSimilarityTransformation", &Circle::getSimilarityTransformation)
  ...
  py::class_<Translator::Generator, Multivector_e1ie2ie3i>(
      m, "TranslatorGenerator")
      .def(py::init<>())
      .def(py::init<const Multivector_e1ie2ie3i &>())
  ...
  py::class_<Translator, Multivector_scalare1ie2ie3i>(m, "Translator")
      ...
      .def_static("exp",
                  static_cast<Translator (*)(const Translator::Generator &)>(
                      &Translator::exp));
  ...
  DECLARE_UNARY_EXPRESSION_WITH_NAMES(Rotor::Exponential, Rotor::Generator,
                                      Rotor, Rotor_Exponential, Rotor)

  py::class_<Rotor_Exponential, Expression_UnaryExpression_Rotor_Exponential>(
      m, "RotorExponential")
  ...
  // Motor::Generator
  py::class_<Motor::Generator, Multivector_e12e13e23e1ie2ie3i>(m,
                                                               "MotorGenerator")
      .def(py::init<>())
  ...
  // Motor::Logarithm
  DECLARE_UNARY_EXPRESSION_WITH_NAMES(Motor::Logarithm, Motor, Motor::Generator,
                                      Motor_Logarithm, Motor_Generator)

  py::class_<Motor_Logarithm, Expression_UnaryExpression_Motor_Logarithm>(
      m, "MotorLogarithm")
      ...
      .def_static("jacobian",
                  static_cast<Eigen::Matrix<double, 6, 8> (*)(const Motor &)>(
                      &Motor::Logarithm::getJacobian));

  // Motor::Exponential
  DECLARE_UNARY_EXPRESSION_WITH_NAMES(Motor::Exponential, Motor::Generator,
                                      Motor, Motor_Exponential, Motor)

  py::class_<Motor_Exponential, Expression_UnaryExpression_Motor_Exponential>(
      m, "MotorExponential")
      ...
      .def_static("jacobian", static_cast<Eigen::Matrix<double, 8, 6> (*)(
                                  const Motor::Generator &)>(
                                  &Motor::Exponential::getJacobian));
