...
class TestSingleManipulatorDualTargetPointToolSphereTarget(unittest.TestCase):
    ...
    def testGetError(self):
        ...
        self.assertAlmostEqual(error[3], 2.005)
        self.assertAlmostEqual(error[4], -3.0)
        self.assertAlmostEqual(error[5], 0.0)
        self.assertAlmostEqual(error[6], 4.5)
        self.assertAlmostEqual(error[7], 0.0)
        self.assertAlmostEqual(error[8], -1.515)
        self.assertAlmostEqual(error[9], 0.0)

        error = self.cost_function.getError([0.0, math.pi / 4.0, 0.0])

        self.assertAlmostEqual(error[0], -0.292893, places=5)
        self.assertAlmostEqual(error[1], -0.707107, places=5)
        self.assertAlmostEqual(error[2], 0.0)
        self.assertAlmostEqual(error[3], 1.41921, places=5)
        self.assertAlmostEqual(error[4], -1.29289, places=5)
        self.assertAlmostEqual(error[5], 0.0)
        self.assertAlmostEqual(error[6], 2.14998, places=5)
        self.assertAlmostEqual(error[7], 0.0)
        self.assertAlmostEqual(error[8], -1.0742, places=5)
        self.assertAlmostEqual(error[9], 0.0)
        ...
        self.assertAlmostEqual(error[5], 0.0)
        self.assertAlmostEqual(error[6], 0.005)
        self.assertAlmostEqual(error[7], 0.0)
        self.assertAlmostEqual(error[8], -0.01)
        self.assertAlmostEqual(error[9], 0.0)
    ...
    def testGetJacobian(self):
        ...
        self.assertAlmostEqual(jacobian[4, 0], 8.0)
        self.assertAlmostEqual(jacobian[5, 0], 0.0)
        self.assertAlmostEqual(jacobian[6, 0], -9.98)
        ...
        self.assertAlmostEqual(jacobian[4, 1], 4.0)
        self.assertAlmostEqual(jacobian[5, 1], 0.0)
        self.assertAlmostEqual(jacobian[6, 1], -4.99)
        ...
        self.assertAlmostEqual(jacobian[0, 0], 3.41421, places=5)
        self.assertAlmostEqual(jacobian[1, 0], 1.41421, places=5)
        self.assertAlmostEqual(jacobian[2, 0], 0.0)
        self.assertAlmostEqual(jacobian[3, 0], -1.41421, places=5)
        self.assertAlmostEqual(jacobian[4, 0], 8.24264, places=5)
        self.assertAlmostEqual(jacobian[5, 0], 0.0)
        self.assertAlmostEqual(jacobian[6, 0], -9.93268, places=5)
        self.assertAlmostEqual(jacobian[7, 0], 0.0)
        self.assertAlmostEqual(jacobian[8, 0], -0.700036, places=5)
        self.assertAlmostEqual(jacobian[9, 0], 0.0)

        self.assertAlmostEqual(jacobian[0, 1], 1.41421, places=5)
        self.assertAlmostEqual(jacobian[1, 1], 1.41421, places=5)
        self.assertAlmostEqual(jacobian[2, 1], 0.0)
        self.assertAlmostEqual(jacobian[3, 1], -2.82843, places=5)
        self.assertAlmostEqual(jacobian[4, 1], 4.24264, places=5)
        self.assertAlmostEqual(jacobian[5, 1], 0.0)
        self.assertAlmostEqual(jacobian[6, 1], -6.35689, places=5)
        self.assertAlmostEqual(jacobian[7, 1], 0.0)
        self.assertAlmostEqual(jacobian[8, 1], 2.12839, places=5)
        self.assertAlmostEqual(jacobian[9, 1], 0.0)
        ...
        self.assertAlmostEqual(jacobian[1, 0], 2.0)
        self.assertAlmostEqual(jacobian[2, 0], 0.0)
        self.assertAlmostEqual(jacobian[3, 0], -2.0)
        self.assertAlmostEqual(jacobian[4, 0], 6.0)
        self.assertAlmostEqual(jacobian[5, 0], 0.0)
        self.assertAlmostEqual(jacobian[6, 0], -6.99)
        self.assertAlmostEqual(jacobian[7, 0], 0.0)
        self.assertAlmostEqual(jacobian[8, 0], -0.99)
        self.assertAlmostEqual(jacobian[9, 0], 0.0)

        self.assertAlmostEqual(jacobian[0, 1], 0.0)
        self.assertAlmostEqual(jacobian[1, 1], 2.0)
        self.assertAlmostEqual(jacobian[2, 1], 0.0)
        self.assertAlmostEqual(jacobian[3, 1], -4.0)
        self.assertAlmostEqual(jacobian[4, 1], 2.0)
        self.assertAlmostEqual(jacobian[5, 1], 0.0)
        self.assertAlmostEqual(jacobian[6, 1], -4.0)
        self.assertAlmostEqual(jacobian[7, 1], 0.0)
        self.assertAlmostEqual(jacobian[8, 1], 3.01)
        self.assertAlmostEqual(jacobian[9, 1], 0.0)
